...
class _ReportFoundItemScreenState extends State<ReportFoundItemScreen> {
  ...
  final _validationQuestionController = TextEditingController();
  ...
  void dispose() {
    ...
    _validationQuestionController.dispose();
    super.dispose();
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final item = Item(
          ...
          userId: userId,
          isLost: false,
          validationQuestion: _validationQuestionController.text.trim().isNotEmpty ? _validationQuestionController.text.trim() : null,
        );
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              TextFormField(
                controller: _validationQuestionController,
                decoration: const InputDecoration(
                  labelText: 'Validation Question (optional)',
